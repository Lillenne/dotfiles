...
* Ente
:PROPERTIES:
:ID:       0dccfabc-8e90-419c-bd90-2023335b45ef
:END:
Pass secret service provides lib.freedesktop.secrets for ente

#+begin_src shell :eval no :tangle no
install pass-secret-service-bin ente-auth-bin
#+end_src
* Linphone
#+begin_src shell :eval no :tangle no
install linphone-desktop-appimage
#+end_src
* Pp
#+begin_src shell
