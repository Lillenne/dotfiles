...
[data.git.credential]
helper = "/mnt/c/Users/<user>/scoop/apps/git-credential-manager/current/git-credential-manager.exe"

[data.github]
user = ""
#+end_src
note: helper path for Git Credential Manager installed with Scoop to WSL.
