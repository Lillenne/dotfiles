...
(doom! :input
       ...
       (org +roam2 +pandoc +crypt +pretty +hugo +present +noter)               ; organize your plain life in plain text
       ;;php               ; perl's insecure younger brother
       ;;plantuml          ; diagrams for confusing people more
       ;;purescript        ; javascript, but functional
       (python +conda +cython +pyright +lsp +tree-sitter)            ; beautiful is better than ugly
       ...
       (rust +lsp +tree-sitter) ;getting errors       ; Fe2O3.unwrap().unwrap().unwrap().unwrap()
